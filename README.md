...
|keras24.csv|0.60606|___0.66847___|svd_sqrt_varianced512[:,:40]|
...
|keras29.csv|||svd_sqrt_varianced512[:,:40],行std|
|keras30.csv|||svd_standard_varianced512[:,:40],行std|
|keras31.csv|||svd_log_varianced512[:,:40],行std|
|keras32.csv||||
|keras33.csv||||
|keras34.csv||||
|keras35.csv||||
